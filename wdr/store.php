...
function codex_store_init() {
	$labels = array(
		...
		'name_admin_bar'     => _x( '門市據點', 'add new on admin bar', 'ice' ),
		'add_new'            => _x( '新增', 'store', 'ice' ),
		'add_new_item'       => __( '新增門市', 'ice' ),
		'new_item'           => __( '新增門市', 'ice' ),
		'edit_item'          => __( '編輯門市', 'ice' ),
		'view_item'          => __( '查看門市資訊', 'ice' ),
