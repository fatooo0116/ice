			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div id="private_note" >
					...
					<div class="note"  id="nt1">
						<div class="ask">
							<p>非常歡迎您光臨「春一枝商行網站」（以下簡稱本網站），為了讓您能夠安心使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：</p>
						</div>
...
本網站在您註冊會員時，我們將向您收集的基本個人資料包含：</p>
						...
						<div class="ask">
							<p>我們所向您收集的個人資料將會作為以下用途：</p>
							<ul>
								<li>1) 運送您在本網站所購買的商品</li>
								<li>2) 提供商品運送狀況和客戶支援的最新消</li>
								<li>3) 為您提供有關商品的資料</li>
								<li>4) 處理您的訂單, 或根據您的要求或透過我們網站提供服務和資訊</li>
							</ul>
						</div>
						<div class="ask">
						...
						<div class="ask">
							<p>為提供精確的服務，我們會將收集的網站數據內容進行統計與分析，分析結果之統計數據或說明文字呈現，除供內部研究外，我們會視需要公佈統計數據及說明文字，但不涉及特定個人之資料。</p>
						</div>
						...
						<h3>七、隱私權保護政策之修正</h3>
						<div class="ask">
							<p>春一枝商行保留隨時修改和更改隱私權政策的權利，修正後的條款將刊登於網站上。</p>
						</div>

						<h3>八、有關違反隱私權條例的投訴</h3>
						<div class="ask">
							<p>如果對我們處理客戶隱私或投訴的方法有任何疑惑，請透過2008springtour@gmail.com聯繫我們。</p>
						</div>
